        ...
        <div className="min-h-screen bg-[#F3F4F6] flex flex-col justify-center items-center font-sans">
            <div className="w-full max-w-120 p-6">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 text-sm">Access the future of e-commerce with TRC-20</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1.5">
                                ...
                                <a href="#" className="text-xs font-semibold text-emerald-500 hover:text-emerald-600">Forgot password?</a>
                            </div>
                            <input
                                type="password"
                                name="password"
                ...
                <div className="text-center mt-8">
                    <p className="text-gray-500 text-sm">
                        Don't have an account? <a href="/register" className="text-emerald-500 font-bold hover:text-emerald-600">Sign up</a>
                    </p>
                </div>
