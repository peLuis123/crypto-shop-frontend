                            ...
                            <div className="bg-white rounded-xl border border-gray-100 p-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500">
                                ...
                                <div className="mt-6 flex gap-3">
                                    <button className="px-6 py-3 bg-emerald-400 hover:bg-emerald-500 text-white font-semibold rounded-lg transition-all">
                                        Save Changes
                                    </button>
                                    <button className="px-6 py-3 border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold rounded-lg transition-all">
                                        Cancel
                                    </button>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-lg">
                                        ...
                                        <p className="font-mono text-sm text-gray-900 break-all">
                                            {user?.wallet || 'TLR3qG5yjpGKzW9x1B2n4Rr6S7T8U9vkK9zw4pXQv'}
                                        </p>
                                    </div>
                                    ...
                                    <button className="w-full py-3 border-2 border-gray-300 hover:border-emerald-400 hover:bg-emerald-50 text-gray-700 hover:text-emerald-600 font-semibold rounded-lg transition-all">
                                        Disconnect Wallet
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl border border-gray-100 p-6">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                        ...
                                        <button className="px-4 py-2 bg-emerald-400 hover:bg-emerald-500 text-white font-semibold rounded-lg transition-all">
                                            Enable
                                        </button>
                                    </div>
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-500">Last active: Just now • Current session</p>
                                                    </div>
                                                </div>
                                                <span className="px-2 py-1 bg-emerald-100 text-emerald-600 text-xs font-semibold rounded">ACTIVE</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
